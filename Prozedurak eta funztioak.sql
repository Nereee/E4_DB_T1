...
CREATE PROCEDURE abestiagehitu(
    IN idaudio VARCHAR(7), 
    IN izena VARCHAR(40), 
    IN iraupena TIME, 
    IN mota ENUM('podcast','abestia')
)
reads sql data
BEGIN
    ...
    VALUES (
        ...
        iraupena, 
        mota, 
        FROM_BASE64(''));
end;
//
delimiter;
--   premium tartea
